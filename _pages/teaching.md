...
<h3 class="mt-4">University of Minnesota</h3>

<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="text-center">
        <h6 class="col-xs-2 col-md-2 title font-weight-bold">Linear Algebra and Differential Equations</h6>
      </div>
...
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
        <h5 class="font-weight-normal">College Algebra & Probability</h5>
      </div>
      <div class="col-sm-2 text-left text-sm-right">
        <span class="badge font-weight-bold text-uppercase align-middle">
            MATH 1031
...
<div class="card mt-3">
  <div class="p-3">
    <div class="row">
      <div class="col-sm-10">
        <h5 class="font-weight-normal">Calculus I</h5>
      </div>
      <div class="col-sm-2 text-left text-sm-right">
        <span class="badge font-weight-bold text-uppercase align-middle">
            MATH 1271
